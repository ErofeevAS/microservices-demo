...
import com.microservices.demo.kafka.to.elastic.service.transofrmer.AvroToElasticModelTransformer;
...
public class TwitterKafkaConsumer implements KafkaConsumer<Long, TwitterAvroModel> {
    ...
    public void receive(@Payload List<TwitterAvroModel> messages,
        ...
        List<String> documentsIds = elasticIndexClient.save(elasticModels);
        LOG.info("Documents save to elasticsearch with ids {}", documentsIds.toArray());
    }
}
